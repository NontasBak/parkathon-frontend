...
export default function UserProfile() {
  ...
  const fetchFrequentLocations = async () => {
    try {
      ...
      setToastMessage("Failed to load frequent locations");
      setToastType("error");
    }
  };
